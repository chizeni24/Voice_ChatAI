...
5. Closing:
   - Thank the customer for considering Bayou Movers.
   - Provide reassurance:
     - "We’ll take great care of your move! Someone will be in touch soon to finalize everything."
...
async def handle_incoming_call(request: Request):
    ...
    response.say("Please wait while we connect your call to the A. I. voice assistant, CyberRails through OpenAI")
    ...
    initial_conversation_item = {
        ...
        "item": {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Greet the user with 'Hello there! I am Bayou's voice assistant that will be helping to answer any questions and create your booking. How can I help you?'"
                }
            ]
        }
    }
